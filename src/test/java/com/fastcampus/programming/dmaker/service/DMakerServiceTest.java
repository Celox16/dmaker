...
import static com.fastcampus.programming.dmaker.type.StatusCode.EMPLOYED;
...
class DMakerServiceTest {
    ...
    public void testSomething() {
        ...
        assertEquals(FRONT_END, developerDetail.getDeveloperSikllType());
    ...
    void createDeveloperTest_success() {
        ...
        assertEquals(FRONT_END, savedDeveloper.getDeveloperSikllType());
    ...
    void createDeveloperTest_fail_with_unmatched_level() {
        ...
        dMakerException = assertThrows(DMakerException.class, () -> dMakerService.createDeveloper(
